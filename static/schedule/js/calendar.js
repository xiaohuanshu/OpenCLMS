...
Date.prototype.getWeeksBetw = function (week) {
    var dt1 = week.getTime();
    var dt2 = this.getTime();
    if (dt2 < dt1) {
        return -1;
    }
...
(function ($) {
    ...
    Calendar.prototype._calculate_hour_minutes = function (data) {
        if (this.options.classtime == '') {
            ...
            data.classtime = this.options.classtime;
            data.by_classtime = [];
            $.each(data.events, function (k, e) {
                var s = new Date(parseInt(e.start));
                var f = new Date(parseInt(e.end));
    ...
    Calendar.prototype.getTitle = function () {
        ...
        switch (this.options.view) {
            ...
            case 'month':
                ...
                break;
            case 'week':
                if (this.options.weekbetw) {
                    return this.locale.title_week.format(p.getWeeksBetw(this.options.weekbetw) + 1, p.getFullYear());
                } else {
    ...
    Calendar.prototype._update_month = function () {
        ...
        $('.cal-month-box .cal-row-fluid')
            .on('mouseenter', function () {
                ...
                if (self.options.weekbetw) {
                    if (p.getWeeksBetw(self.options.weekbetw) != -1) {
                        week.html(self.locale.week.format(p.getWeeksBetw(self.options.weekbetw) + 1));
